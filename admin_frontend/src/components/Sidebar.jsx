  ...
  const menuItems = [
    {
     ...
     { text: 'Job create', icon: <AddShoppingCartIcon />, path: '/c-job' },
    
     { text: 'All Orders', icon: <ListAltIcon />, path: '/orders' },
     { text: 'Price Calculator', icon: <CalculateIcon />, path: '/cal' },
      { text: 'EmployeeList', icon: <PersonIcon />, path: '/e-list' },
      { text: 'CustomerList', icon: <PersonIcon />, path: '/c-list' },
