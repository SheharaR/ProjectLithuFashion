...
import z from './z.jpeg'
import z5 from './z5.webp'
import zz from './zz.jpeg'
import zzz from './zzz.jpeg'

export const  assest = {
    expo,MITLogo,email,phone,s6,facebook_icon,twitter_icon,linkedin_icon,td,H1,H2,H3,td2,up,admin,H5,H4,H6,H7,H8,H9,H10,H11,g,g1,g2,g3,g5,g6,icon,b1,b2,b3,b4,s1,s2,s3,s4,s5,z,zz,zzz,z5
}
