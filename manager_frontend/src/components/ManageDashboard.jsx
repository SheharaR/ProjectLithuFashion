...
const AdminDashboard = () => {
  ...
  return (
    <Container style={{marginLeft:'100px'}} fluid className="py-4">
      {error && (
            ...
            <Col md={4}>
              <Card className="text-white bg-primary h-100">
                <Card.Body className="d-flex flex-column align-items-center">
                  ...
                  <Card.Text style={{color:'black'}} className="display-4 mt-3 mb-0 fw-bold">{jobs.length}</Card.Text>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="text-white bg-success h-100">
                <Card.Body className="d-flex flex-column align-items-center">
                  ...
                  <Card.Text style={{color:'black'}} className="display-4 mt-3 mb-0 fw-bold">
