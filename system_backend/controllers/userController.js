...
const registerUser = async (req, res) => {
  const { name, password, email, tel_num, shop_name, shop_address } = req.body;
  try {
    // Validation checks
    ...
    const INSERT_USER_QUERY =
      'INSERT INTO customers (customer_name, email, password, tel_num, shop_name, shop_address, profile_image) VALUES (?, ?, ?, ?, ?, ?, ?)';
