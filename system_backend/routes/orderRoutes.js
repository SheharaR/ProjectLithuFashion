import {createCustomOrder, getAllOrders, getCustomOrders, getOrderByCustomerId, getOrdersByCustomerId, processPayment, updateAmountPaid, updateNewOrderStatus, updateOrderStatus, updatePaymentMethod} from '../controllers/orderController.js';
...
OrderRoutes.put('/update_payment_method',updatePaymentMethod);
